...
bool sh1107_init(SH1107_t * dev, int width, int height);
...
void sh1107_display_text(SH1107_t * dev, int row, int col, const char * text, int text_len, bool invert);
...
void sh1107_wrap_around(SH1107_t * dev, sh1107_scroll_type_t scroll, int start, int end, int8_t delay);
...
bool spi_init(SH1107_t * dev, int width, int height);
